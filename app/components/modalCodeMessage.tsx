...
export default function ModalCodeMessage({
  currentUser,
  setStep,
  accessLevelSelected,
  ...
  const validateAccessLevelSelected = () => {
    if (accessLevelSelected === -1) {
      ...
      accessLevelSelected === "A" ||
      accessLevelSelected === "R" ||
      accessLevelSelected === "N"
    ) {
      nextModal();
    } else {
      ...
      <div className="message">
        ...
        <div className="message-information">
          <p className="just-text">
            Para la creación de un nuevo usuario debera proporcionarle el código
            de creación al usuario en cuestión con el cual podrá llenar el
